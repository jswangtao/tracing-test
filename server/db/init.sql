...
-- ----------------------------
-- Table structure for sys_tracing 监控table
-- ----------------------------
DROP TABLE IF EXISTS `sys_tracing`;
CREATE TABLE `sys_tracing` (
  `tracing_id` int NOT NULL AUTO_INCREMENT COMMENT '监控ID',
  `event_type` varchar(32) NOT NULL COMMENT '事件类型',
  `trigger_page_url` varchar(255) NOT NULL COMMENT '触发页面URL',
